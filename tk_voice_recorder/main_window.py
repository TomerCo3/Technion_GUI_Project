        ...
        if os.path.isdir(users_path) == False:
            ...
            def popup_win():
                ...
                def continue_with_name():
                    ...
                    top2 = Toplevel()
                    top2.configure(bg='#4B4B4B')
                    label2 = tk.Label(top2, text="Great! press start on the buttom of the main page and continue recording the sentences after that press the continue button to continue", bg='#4B4B4B', fg='light gray', highlightbackground='#4B4B4B')
                    exit_btn = tk.Button(top2, text="Exit", bg='#4B4B4B', highlightbackground='#4B4B4B', command=exit_button)
                    label2.grid(row=1, column=0)
                    exit_btn.grid(row=2, column=0)

                top1 = Toplevel()
                top1.configure(bg='#4B4B4B')
                label1 = tk.Label(top1, bg='#4B4B4B', fg='light gray', highlightbackground='#4B4B4B', text="Name already in use, do you want to continue with the name given or enter a differant one?")
                continue_btn = tk.Button(top1, text="Continue", bg='#4B4B4B', highlightbackground='#4B4B4B', command=continue_with_name)
                newName_btn = tk.Button(top1, text="Enter a new name", bg='#4B4B4B', highlightbackground='#4B4B4B', command=enter_new_name)
...
def main_window():
        ...
        if T.get('1.0', 'end-1c') == "Hello, please type in your full name and choose the directory you will be working with, then press continue":
            ...
            try:
                ...
                def popup_window():
                    ...
                    top = Toplevel()
                    top.configure(bg='#4B4B4B')
                    label = tk.Label(top, text="Already recorder the sentence, do you want to update to the new file or remain with the old one and delete the new?", bg='#4B4B4', fg='light gray', highlightbackground='#4B4B4')
                    update_btn = tk.Button(top, text="Update", bg='#4B4B4B', highlightbackground='#4B4B4B', command=update_voice_file)
                    remain_with_old_btn = tk.Button(top, text="Stay with old file", bg='#4B4B4B', highlightbackground='#4B4B4B', command=remain_with_old_file)
    ...
    submit_btn = tk.Button(voice_rec, text='Submit Name', bg='#4B4B4B', highlightbackground='#4B4B4B',  command=getUserName)
