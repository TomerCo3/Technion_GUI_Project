...
def starting_window():
    ...
    def main_window():
        ...
        record_btn = tk.Button(voice_rec, width=20, text="Record Audio", command=start_recording)
        stop_btn = tk.Button(voice_rec, width=20, text="Stop Recording", command=stop_recording)
        play_btn = tk.Button(voice_rec, width=20, text="Play Recording", command=play_recording)
        record_again_btn = tk.Button(voice_rec, command=record_again) 
        continue_btn = tk.Button(voice_rec, text="Continue", command=continue_func)
        quit_btn = tk.Button(voice_rec, text="Quit", command=voice_rec.destroy)
